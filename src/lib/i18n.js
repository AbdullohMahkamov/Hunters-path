...
export const MOP_T = {
  ru: {
    ...
    myFunnel: 'Моя воронка', leads: 'лидов', reach: 'дозвон', conv: 'конверсия', fakeNums: 'нереальных номеров (неверный номер + дубль), исключены из знаменателя',
  ...
  uz: {
    ...
    myFunnel: 'Mening voronkam', leads: 'lid', reach: 'aloqa', conv: 'konversiya', fakeNums: 'notoʻgʻri raqamlar (xato raqam + dubl), maxrajdan chiqarilgan',
