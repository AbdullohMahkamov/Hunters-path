...
export const MOP_T = {
  ru: {
    ...
    gRuleReach: 'за каждый дозвон', gRuleFast: 'за 1-й звонок < 15 мин', gRuleTask: 'за выполненную задачу',
    gRulePlan: 'за закрытый дневной план', gRuleConv: 'за дневную конверсию (по уровню)',
  ...
  uz: {
    ...
    gRuleReach: 'har bir aloqa uchun', gRuleFast: '1-qoʻngʻiroq < 15 daq uchun', gRuleTask: 'bajarilgan vazifa uchun',
    gRulePlan: 'kunlik reja yopilgani uchun', gRuleConv: 'kunlik konversiya uchun (daraja boʻyicha)',
