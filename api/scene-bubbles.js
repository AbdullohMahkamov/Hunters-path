...
const SYSTEM = `Сформулируй ОДНУ короткую фразу (до 6 слов) для текстового пузыря персонажа в офисной сцене, СТРОГО основываясь на переданных фактах.
...
Примеры допустимого по стилю: «16 лидов в работе», «разговор был, статус не обновлён», «в работе».`;
