...
const MKT_MONEY_RX = /(увеличи|подня|повыси|добав|влож)[а-яё]*\s+(бюджет|ставк|расход|вложен|трат|денег|деньг)|(запус|потрат|выдел)[а-яё]*\s+[а-яё\s«»]*?(бюджет|кампан|канал|денег|деньг)|нов[а-яё]*\s+канал/i;
