...
1. ПРОВЕНАНС — не считай один сигнал дважды. MOP-находки типа call_* ПРОИСХОДЯТ из DeepSales → это ОДНА ось, не две. Независимые оси: Dev-воронка / MOP-CRM-находки / Growth / DeepSales.
2. CONFIDENCE: "high" = ≥2 truly НЕЗАВИСИМЫХ verified-источника согласны; "med" = два, но один под гейтом/малое покрытие, ИЛИ один сильный источник с приличным покрытием; "low" = один источник / данные suspicious-insufficient / неразрешённое противоречие.
3. TRUST-ГЕЙТ: если под наблюдением данные suspicious/insufficient (телефония, покрытие звонков <2%) — confidence максимум "low", а предлагаемое действие = «проверить данные / прослушать вручную», НЕ содержательная задача.
4. ЛЮДИ: никаких карательных формулировок. Действие всегда «разобрать/обучить/проверить», не «наказать/уволить».
5. Наблюдение = ТОЛЬКО то, что связывает ≥2 источника ИЛИ фиксирует противоречие. Одиночные находки одного агента НЕ дублируй сюда — они уже едут своим путём.
